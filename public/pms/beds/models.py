...
class Room(models.Model):
    ...
    room_type = models.CharField(
        max_length=7, choices=ROOM_TYPES, verbose_name=_("room type")
    )

    capacity = models.IntegerField(
        verbose_name=_("capacity"), blank=True, default=1
    )  # noqa
...
class Bed(models.Model):
    ...
    base_price = models.DecimalField(
        ...
        decimal_places=2,
        default=0.00,
        verbose_name=_("base price"),  # noqa
    )
