...
class UnitModelTest(TestCase):
    def setUp(self):
        ...
        self.unit = Unit.objects.create(
            name="1", unit_type="SINGLE_BED", room=self.room
        )
    ...
    def test_unit_number_unique_per_room(self):
        ...
        room2 = Room.objects.create(
            property=self.property, name="Room 102", room_type="PRIVATE_ROOM"
        )

        # Debería permitir el mismo nombre
        # de unidad en una habitación diferente
        try:
            ...
            self.fail(
                "No debería lanzar ValidationError para mismo nombre en diferente habitación"  # noqa
            )
